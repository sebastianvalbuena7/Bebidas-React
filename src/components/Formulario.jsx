...
const Formulario = () => {
    ...
    const { consultarBebida, handleModalClickCarrito } = useBebidas()
    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <Row>
                <Col md={6}>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control value={busqueda.nombre} onChange={e => setBusqueda({
                            ...busqueda,
                            [e.target.name]: e.target.value
                        })} id="nombre" type="text" placeholder="Ej: Tequila, Vodka, etc" name="nombre" />
                    </Form.Group>
                </Col>
                <Col md={6}>
                    <Form.Group className="mb-3">
            ...
            <Row>
                <Col>
                    <Button variant="danger" onClick={ () => handleModalClickCarrito() }>
                        <BsFillCartFill />
                    </Button>
                </Col>
                <Col>
